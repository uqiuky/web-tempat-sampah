                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title" id="exampleModalLabel">Tempat Sampah {{ $node_number }}</h3>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col rounded">
                                            <iframe src="{{ $maps }}" width="480" height="300">
                                            </iframe>
                                        </div>
                                        <div class="col align-middle mt-2">
                                            <div class="bg-secondary bg-opacity-25 mb-3 rounded">
                                                ...
                                                <div class="row row-cols-auto justify-content-center">
                                                    <span class="num display-1 px-0" data-val="{{ $cm }}">0</span>
