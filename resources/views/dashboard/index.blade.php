    ...
    <section class="home-section">
        ...
        <div class="row justify-content-center">
            <div class="row row-cols-1 row-cols-md-4 pt-2 text-center">
                <div class="d-flex">
                    @foreach ($trash as $trash)
                        <a href="" class="text-decoration-none" data-bs-toggle="modal"
                            data-bs-target="#exampleModal-{{ $trash->id }}">
                            <div class="card">
                                ...
                                <div class="trash mx-auto">
                                    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        @if ($trash->node_number === 1) data-percent=" {{ $data_1->hcsr }}"
                                        @elseif ($trash->node_number === 2) data-percent=" {{ $data_2->hcsr }}"
                                        @else
                                ...
                                <div class="card-body">
                                    <span class="num fs-1"
                                        @if ($trash->node_number === 1) data-val=" {{ $data_1->hcsr }}"
                                        @elseif ($trash->node_number === 2) data-val=" {{ $data_2->hcsr }}"
                                        @else
                                        data-val="1" @endif>0</span>
                                    <span class="text fs-1">%</span>
                                    <p class="card-text">{{ $trash->location }}</p>
                                </div>
                            </div>
                        </a>
                        <div class="modal fade" id="exampleModal-{{ $trash->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col rounded">
                                                <iframe src="{{ $trash->maps }}" width="480" height="300">
                                                </iframe>
                                            </div>
                                        ...
                                        data-val="1" @endif>0</span>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="bg-secondary bg-opacity-25 rounded">
                                                        ...
                                                        <h3 class="">
                                                            @if ($trash->node_number === 1)
                                                                {{ $data_1->last_update }}
                                                            @elseif ($trash->node_number === 2)
                                                                {{ $data_2->last_update }}
                                                            @else
                                    ...
                                    <div class="modal-footer">
                                        <a type="button" class="btn btn-lg btn-secondary">Hide</a>
                                        <a href="/edit" type="button" class="btn btn-lg btn-primary">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 my-auto opacity-50">
                    <a href="/create">
